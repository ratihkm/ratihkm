...
|3.| [Создание GUI для удаленного управления перистальтическим насосом](https://github.com/ratihkm/Study_projects/blob/main/GUI.png) | Создать графический интерфейс для управления лабораторным насосом, используя протокол Modbus RTU| `Python`, `tkinter`,`pymodbus` |<center>✔️</center>|
