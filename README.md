...
# Мое резюме / CV:
- [Rus](https://github.com/ratihkm/ratihkm/blob/main/Ovsepian_CV_rus.pdf)
- [Eng](https://github.com/ratihkm/ratihkm/blob/main/Ovsepian_CV_eng.pdf)
...
|3.| [Создание GUI для удаленного управления перистальтическим насосом](https://github.com/ratihkm/Study_projects/blob/main/Permeability%20Forecast.ipynb) | Создать графический интерфейс для управления лабораторным насосом, используя протокол Modbus RTU| `Python`, `tkinter`,`pymodbus` |<center>✔️</center>|
